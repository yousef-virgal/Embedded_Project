...
int8 DIO_ReadPin(int8 Port, int8 Pin)
{
    ...
    {
    case PORTA:
        read_pin = Get_Bit(GPIO_PORTA_DATA_R, Pin);
        break;

    case PORTB:
        read_pin = Get_Bit(GPIO_PORTB_DATA_R, Pin);
        break;

    case PORTC:
        read_pin = Get_Bit(GPIO_PORTC_DATA_R, Pin);
        break;

    case PORTD:
        read_pin = Get_Bit(GPIO_PORTD_DATA_R, Pin);
        break;

    case PORTE:
        read_pin = Get_Bit(GPIO_PORTE_DATA_R, Pin);
        break;
...
int8 DIO_ReadPort(int8 Port)
{
    ...
    case PORTA:
        read_register = Get_Register(GPIO_PORTA_DATA_R);
        break;

    case PORTB:
        read_register = Get_Register(GPIO_PORTB_DATA_R);
        break;

    case PORTC:
        read_register = Get_Register(GPIO_PORTC_DATA_R);
        break;

    case PORTD:
        read_register = Get_Register(GPIO_PORTD_DATA_R);
        break;

    case PORTE:
        read_register = Get_Register(GPIO_PORTE_DATA_R);
        break;

    case PORTF:
        read_register = Get_Register(GPIO_PORTF_DATA_R);
        break;
    }
